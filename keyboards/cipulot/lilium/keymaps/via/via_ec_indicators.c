...
enum via_enums {
    ...
    id_mode_1_initial_deadzone_offset = 8,
    id_mode_1_actuation_sensitivity = 9,
    id_mode_1_release_sensitivity = 10,
    id_bottoming_calibration = 11,
    id_show_calibration_data = 12
    // clang-format on
};
...
void via_config_set_value(uint8_t *data) {
    ...
    switch (*value_id) {
        case id_caps_indicator_enabled: {
            eeprom_ec_config.caps.enabled = value_data[0];
            break;
        }
        ...
        case id_layers_indicator_enabled: {
            eeprom_ec_config.layer_indicator_enabled = value_data[0];
            break;
        }
