...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_60_tsangan_hhkb(
        ...
        KC_CAPS, _______, _______, _______, _______, _______, _______, _______,   KC_PSCR, KC_SCRL, KC_PAUSE, KC_UP,    _______,  _______,
        KC_LCTL, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, S(KC_8),   KC_SLSH, KC_HOME, KC_PGUP, KC_LEFT,  KC_RIGHT,           KC_ENTER,
